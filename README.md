...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/transformers-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/transformers-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi global install transformers
```
...
It is possible to list all of the versions of `transformers` available on your platform:
...
```
pixi search transformers --channel conda-forge
```
